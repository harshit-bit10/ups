...
def upscale_and_enhance(img: Image.Image) -> Image.Image:
    try:
        ...
        img_upscaled = ImageEnhance.Contrast(img_upscaled).enhance(0.9)  # Increase contrast
        img_upscaled = ImageEnhance.Color(img_upscaled).enhance(0.5)  # Slightly boost colors
